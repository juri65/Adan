...
Post.create!(
  [
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post1.jpg"), filename:"sample-post1.jpg"), text: '空から見る空', user_id: users[0].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post2.jpg"), filename:"sample-post2.jpg"), text: '夜明け', user_id: users[1].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post3.jpg"), filename:"sample-post3.jpg"), text: 'ミラーが綺麗だったよ', user_id: users[2].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post4.jpg"), filename:"sample-post4.jpg"), text: '夏が来たって感じ', user_id: users[3].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post5.jpg"), filename:"sample-post5.jpg"), text: 'いい天気、ピンクのルアーが可愛い', user_id: users[4].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post6.jpg"), filename:"sample-post6.jpg"), text: '雪山の空', user_id: users[5].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post7.jpg"), filename:"sample-post7.jpg"), text: '富山に行ってきたよ', user_id: users[6].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post8.jpg"), filename:"sample-post8.jpg"), text: '朝日、素敵な一日になりますように', user_id: users[7].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post9.jpg"), filename:"sample-post9.jpg"), text: '水がめちゃくちゃ綺麗！', user_id: users[8].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post10.jpg"), filename:"sample-post10.jpg"), text: '水遊びしたよ', user_id: users[9].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post11.jpg"), filename:"sample-post11.jpg"), text: 'プール日和', user_id: users[10].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post12.jpg"), filename:"sample-post12.jpg"), text: 'ポニーいた！！', user_id: users[11].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post13.jpg"), filename:"sample-post13.jpg"), text: '桜が綺麗でした', user_id: users[12].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post14.jpg"), filename:"sample-post14.jpg"), text: '海辺のランチ', user_id: users[13].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post15.jpg"), filename:"sample-post15.jpg"), text: '釣りは癒される', user_id: users[14].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post16.jpg"), filename:"sample-post16.jpg"), text: '透明度すごかった', user_id: users[15].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post17.jpg"), filename:"sample-post17.jpg"), text: '夏の空が大好き', user_id: users[16].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post18.jpg"), filename:"sample-post18.jpg"), text: 'ガス抜けてピーカン', user_id: users[17].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post19.jpg"), filename:"sample-post19.jpg"), text: '夕方少しだけ海辺の散歩', user_id: users[18].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post20.jpg"), filename:"sample-post20.jpg"), text: '空の境目が、、、', user_id: users[19].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post21.jpg"), filename:"sample-post21.jpg"), text: '今日は釣れますように', user_id: users[20].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post22.jpg"), filename:"sample-post22.jpg"), text: '虹！いい事ありそう', user_id: users[21].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post23.jpg"), filename:"sample-post23.jpg"), text: '池に空が映ってて綺麗だったよ', user_id: users[22].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post24.jpg"), filename:"sample-post24.jpg"), text: 'この先にカフェがあるなんて', user_id: users[23].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post25.jpg"), filename:"sample-post25.jpg"), text: '幸せを感じる瞬間', user_id: users[24].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post26.jpg"), filename:"sample-post26.jpg"), text: '初日の出！！', user_id: users[25].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post27.jpg"), filename:"sample-post27.jpg"), text: '冬空サイコー', user_id: users[26].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post28.jpg"), filename:"sample-post28.jpg"), text: '太陽が眩しい', user_id: users[27].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post29.jpg"), filename:"sample-post29.jpg"), text: '見事なミラー。景色としては最高', user_id: users[28].id },
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post30.jpg"), filename:"sample-post30.jpg"), text: '可愛いブランコあったよ〜', user_id: users[29].id }
  ]
)
